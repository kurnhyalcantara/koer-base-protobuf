...
// LoginRequest contains the credentials to log in.
...
// LoginResponse contains the authentication token logic.
...
// ValidateTokenRequest accepts an encoded access token for validation.
...
// ValidateTokenResponse returns the validity state and associated user details.
...
const file_auth_service_v1_auth_proto_rawDesc = "" +
	"\n" +
	"\x1aauth-service/v1/auth.proto\x12\aauth.v1\"@\n" +
	...
	"\rValidateToken\x12\x1d.auth.v1.ValidateTokenRequest\x1a\x1e.auth.v1.ValidateTokenResponse\"\x00BMZKgithub.com/kurnhyalcantara/koer-base-protobuf/gen/go/auth-service/v1;authv1b\x06proto3"
...
var file_auth_service_v1_auth_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
